...
import de.blinkt.openvpnsc.activities.LogWindow;
import de.blinkt.openvpnsc.api.ExternalAppDatabase;
import de.blinkt.openvpnsc.core.ConnectionStatus;
import de.blinkt.openvpnsc.core.IServiceStatus;
import de.blinkt.openvpnsc.core.OpenVPNStatusService;
import de.blinkt.openvpnsc.core.PasswordCache;
import de.blinkt.openvpnsc.core.Preferences;
import de.blinkt.openvpnsc.core.ProfileManager;
import de.blinkt.openvpnsc.core.VPNLaunchHelper;
...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "de.blinkt.openvpnsc.shortcutProfileUUID";
    public static final String EXTRA_NAME = "de.blinkt.openvpnsc.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "de.blinkt.openvpnsc.showNoLogWindow";
    ...
    private String mTransientTokenPin;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder binder) {
            ...
            try {
                ...
                if (mTransientTokenPin != null)
                    service.setCachedPassword(mSelectedProfile.getUUIDString(), PasswordCache.TOKENPIN, mTransientTokenPin);
        ...
        AlertDialog.Builder builder = dialog.setPositiveButton(android.R.string.ok,
                new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        } else if (type == R.string.token_pin) {
                            mTransientTokenPin = entry.getText().toString();
                        } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == START_VPN_PROFILE) {
            if (resultCode == Activity.RESULT_OK) {
                int needpw = mSelectedProfile.needUserPWInput(mTransientCertOrPCKS12PW, mTransientAuthPW, mTransientTokenPin);
                if (needpw != 0) {
