...
public class PasswordCache {
    ...
    public static String getTokenPin(UUID uuid, boolean resetPW) {
        String pwcopy = getInstance(uuid).mTokenPin;
        if (resetPW)
            getInstance(uuid).mTokenPin = null;
        return pwcopy;
    }
