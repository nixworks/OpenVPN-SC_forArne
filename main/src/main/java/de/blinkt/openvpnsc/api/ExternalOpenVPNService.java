...
package de.blinkt.openvpnsc.api;
...
import de.blinkt.openvpnsc.core.ConfigParser;
import de.blinkt.openvpnsc.core.ConfigParser.ConfigParseError;
import de.blinkt.openvpnsc.core.ConnectionStatus;
import de.blinkt.openvpnsc.core.IOpenVPNServiceInternal;
...
public class ExternalOpenVPNService extends Service implements StateListener {
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            int neddPassword = vp.needUserPWInput(null, null, null);

            if(vpnPermissionIntent != null || neddPassword != 0){
                Intent shortVPNIntent = new Intent(Intent.ACTION_MAIN);
                shortVPNIntent.setClass(getBaseContext(), de.blinkt.openvpnsc.LaunchVPN.class);
                shortVPNIntent.putExtra(de.blinkt.openvpnsc.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(de.blinkt.openvpnsc.LaunchVPN.EXTRA_HIDELOG, true);
