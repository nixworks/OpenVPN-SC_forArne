...
void Java_de_blinkt_openvpnsc_core_NativeUtils_jniclose(JNIEnv *env,jclass jo, jint fd)
{
	int ret = close(fd);
}
...
jstring Java_de_blinkt_openvpnsc_core_NativeUtils_getJNIAPI(JNIEnv *env, jclass jo)
{
