...
public enum Pkcs11MechanismType implements Supplier<Long> {
    ...
    public static Pkcs11MechanismType fromValue(long value) {
        for (Pkcs11MechanismType val : values()) {
    ...
    Pkcs11MechanismType(long value) {
        mValue = value;
    }
